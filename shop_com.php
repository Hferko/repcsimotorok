        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="col-md-10">
                        <ul class="list-inline shop-top-menu p-3">
                            <li class="list-inline-item">
                                <p class="h3 text-dark text-decoration-none mr-3">Kereskedelmi gépek turbinái</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    $sorokSzama = sorokSzama_keredkedelmi();
                    $eredmeny = tablaTartalom_kereskedelmi($kezdes, $limit);

                    if (!$eredmeny) {
                        print(mysqli_error($conn) . ' ' . mysqli_errno($conn));
                    } else {
                        tablaRajz($eredmeny);
                        pager_kereskedelmi($limit, $aktual_oldal, $sorokSzama);
                    }
